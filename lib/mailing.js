...
export default function sendMail(mailTo, subject, title, text) {
  ...
  let mailOptions = {
    from: '[AutoSur] noreply@vinsnaturels.fr', // Adresse de l'expéditeur
    to: mailTo, // Liste des destinataires
    subject: subject, // Sujet du courrier
    text: 'Je vous confirme votre RDV le  à ', // Corps en texte brut
    html: templateFile + text + templateFile2, // Corps HTML du courrier
  }; 
